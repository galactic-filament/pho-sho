...
abstract class AbstractTestCase extends WebTestCase
{
  ...
  protected function _testRequest($method, $url, array $headers = [], $body = '', $expectedStatus = Response::HTTP_OK)
  {
  ...
  protected function _testJson($method, $url, array $body = [], $expectedStatus = Response::HTTP_OK)
  {
    list($client, $crawler) = $this->_testRequest(
      $method,
      $url,
